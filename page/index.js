...
export const [
	...
	globalThis__be_('page__host', ctx=>
		derived_(page$_(ctx),
			page=>
				page ? page.host : null
		)))
...
export const [
	...
	globalThis__be_('page__path', ctx=>
...
export const [
	...
	globalThis__be_('page__params', ctx=>
		derived_(page$_(ctx), page=>
...
export const [
	...
	globalThis__be_('page__query', ctx=>
		derived_(page$_(ctx), page=>
...
export const [
	...
	globalThis__be_('page__error', ctx=>
		derived_(page$_(ctx), page=>
