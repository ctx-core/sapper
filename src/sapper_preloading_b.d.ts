...
export declare const sapper_preloading_b: import("@ctx-core/object").Be<sapper_preloading_Ctx, "sapper_preloading", sapper_preloading_T>;
...
export { sapper_preloading_b as b__preloading__sapper };
